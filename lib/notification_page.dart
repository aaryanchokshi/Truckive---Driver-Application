...
class _NotificationsPageState extends State<NotificationsPage>
  ...
  Future<void> _addNotificationsToFirebase() async {
    try {
      await _notificationsRef.set(jobNotifications
          .map((notification) => notification.toMap())
          .toList());
    } catch (e) {
      print('Error adding notifications to Firebase: $e');
    }
  }
